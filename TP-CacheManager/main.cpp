...
int main() {
	...
	cout << " ---------------------- INSERT ----------------------- " << endl;
	my_cache._insert("1", Student(0, 22, "Leandro"));
	my_cache._insert("2", Student(1, 23, "Martin"));
	...
	cout << " ---------------------- INSERT ----------------------- " << endl;
	my_cache._insert("3", Student(2, 25, "Abril"));
	my_cache._insert("4", Student(3, 29, "Valentin"));
	...
	cout << " ---------------------- UPDATE ----------------------- " << endl;
	my_cache._insert("5", Student(4, 22, "Estanislao"));
	...
	cout << " ---------------------- UPDATE ----------------------- " << endl;
	my_cache._insert("3", Student(9, 25, "Ezequiel"));
