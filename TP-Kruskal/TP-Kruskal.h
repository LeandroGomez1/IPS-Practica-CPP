// TP-Kruskal.h : Include file for standard system include files,
...
/**
	...
	* un intero como indice de cantidad de adyacencias y el primer
...
public:
	...
	void insertar_arista(const char&, const char&, const
